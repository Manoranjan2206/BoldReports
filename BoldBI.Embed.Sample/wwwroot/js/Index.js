...
function loadDashboard(element, selectedDashboardId) {
...
function renderDashboard(dashboardId) {
    ...
    // destroy previous dashboard safely
    if (dashboardObj && typeof dashboardObj.destroy === "function") {
        dashboardObj.destroy();
    }

    dashboardObj = BoldBI.create({
